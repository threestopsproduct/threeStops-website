                            ...
                            <FormControlLabel
                                ...
                                control={
                                    ...
                                    <Checkbox
                                        ...
                                        icon={<FiberManualRecordSharp className={classes.sizeIconPlus} />}
                                        checkedIcon={<CheckCircle className={classes.sizeIcon} />}
                                        onChange={(e)=>this.props.handleChange(e,this.props.title2)}
                                    />
                                }
...
export default withStyles(styles)(SelectMulti);