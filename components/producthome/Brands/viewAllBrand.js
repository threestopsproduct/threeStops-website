            ...
            <Wrapper>
              ...
              {/* <div className ="p-4">
                  <h6> All Brands</h6>
                    ...
                    <div className="row">
                        <div className="col-12 p-0 brands featuredItemsId customBgWhiteSection wrapLayout d-flex" style={{flexWrap: "inherit",justifyContent:"center"}}>
                        <div className="row mobileView1">
                            ...
                            {/* <Slider {...settings}> */}
                                {props.productsList ? props.productsList.map((brand, index) =>
                                    <div   key={"brandImages-" + index}>
                                        <div >
                                            <div className="card card-cascade pl-3" 
                                            ...
                                            onClick={() => Router.push(`/brands?name=${brand.name.en.replace('&', '%26')}&store=${props.selectedStore._id}` , `/brands/${brand.name.en.replace(/%20/g, '-').replace(/ /g, '-').replace('&', '%26')}`).then(() => window.scrollTo(0, 0))}  >
                                                <div className="view overlay">
                                                    <img src={brand.logoImage ||brand.bannerImage || "/static/images/unknown.png"} width="142" height="150px" className="img-fluid" alt={brand.brandName} />
                                                    <a>
