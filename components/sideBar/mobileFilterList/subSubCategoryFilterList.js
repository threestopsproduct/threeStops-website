...
class SubSubCatFilter extends Component {
    state = {
        SliderWidth: 0,
        open: true,
        supportData: null,
                ...
                >
                    <div className="row align-items-center pt-2 pb-2 px-4" style={{ right: '0px', backgroundColor: "white" }}>
                        ...
                        <div className="col-8 pt-2 text-center">
                            <h6 style={{ fontSize: '16px', fontWeight: '700', color: '#333' }}>Sub Sub Categories</h6>
                        </div>
                        {/* {this.props.showAdd ?
                    ...
                    <FormControl component="fieldset" required error className={classes.formGroup}>
                        {
                            this.props.subSubCat && this.props.subSubCat.map((category, index) =>
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            value={category}
                                            ...
                                            onChange={this.props.handleChange('sub-sub-category')}
                                        />
                                    }
                                    label={category}
                                    classes={{
...
export default withStyles(styles)(SubSubCatFilter);