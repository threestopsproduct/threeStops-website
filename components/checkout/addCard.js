...
class AddCardLeftSlider extends Component {
  ...
  componentDidMount() {
    ...
    let PriceValue = couponBenifit
      ? parseFloat(
          parseFloat(this.props.driverTip || 0) +
            parseFloat(this.props.serviceFees || 0) +
            parseFloat(deliveryFeesTotal) +
            parseFloat(myCart.finalTotalIncludingTaxes) -
            parseFloat(couponBenifit.discountAmount)
        ).toFixed(2)
      : parseFloat(
          parseFloat(this.props.driverTip || 0) +
            parseFloat(this.props.serviceFees || 0) +
    ...
    console.log(
      ...
      deliveryFeesTotal,
      myCart.finalTotalIncludingTaxes,
      "PriceValue"
    );
  ...
  addCard(result) {
    ...
    let walltevalue =
      walletRechargeAmount && walletRechargeAmount.length > 0
        ? walletRechargeAmount
        : PriceValue;
    ...
    let appId =
      this.props.caseFreeData &&
      this.props.caseFreeData.data &&
      this.props.caseFreeData.data.appId.length > 0
        ? this.props.caseFreeData.data.appId
        : "";
    let customerName =
    ...
    let orderId =
      this.props.caseFreeData &&
      this.props.caseFreeData.data &&
      this.props.caseFreeData.data.orderId.length > 0
        ? this.props.caseFreeData.data.orderId
        : "";
    let customerEmail =
      this.props.userProfile &&
    ...
    let secretKey =
      this.props.caseFreeData &&
      this.props.caseFreeData.data &&
      this.props.caseFreeData.data.secretKey.length > 0
        ? this.props.caseFreeData.data.secretKey
        : "";
    ...
    (data.returnUrl =
      this.props.check == "check" ? `${Origin}/profile` : `${Origin}/checkout`),
...
export default connect(mapStateToProps)(LanguageWrapper(AddCardLeftSlider));
